                            ...
                            flexDirection: 'row'}}>
                                <View style={{
                                    ...
                                    <View style={{
                                        flexDirection: 'col', 
                                        paddingTop:5}}>
                                   <Text>Reporte de Citas. Fecha: {diaMes}-{numeroMes+1}-{numeroAño}, Hora {hora>=0&&hora<=9?("0"+hora):(hora)}:{minutos>=0&&minutos<=9?("0"+minutos):(minutos)}:{segundos>=0&&segundos<=9?("0"+segundos):(segundos)} {hora>=0&&hora<=9?("AM"):("PM")}</Text>
                                  <Text></Text> 
                                    </View>
                                </View> 
                            </View>
